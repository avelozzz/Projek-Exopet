...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/2.0.7/css/dataTables.dataTables.css.css">

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">

    <title>:Exo Pet : - @yield('title')</title>
</head>
<body>
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="row">
            <div class="col-md-2 bg-warning vh-100 ">
              <div class="row mt-4">
                <div class="col-3">
                  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link {{ ($key == "home" ) ? "active":"" }}" id="v-pills-home-tab" href="/home" >Home</a>
                    <a class="nav-link {{ ($key == "masterdata" ) ? "active":"" }}" id="v-pills-profile-tab" href="/masterdata" >Masterdata</a>
            ...
            <div class="col-md-10 bg-dark  vh-100">
              <div class="card mt-4">
